        ...
        <div className="container pb-80 pt-80 ontop">
          <div className="row">
            <div className="col-lg-6">
              <div className="eml">
                <h6 className="sub-title opacity-8">I would love to hear from you.</h6>
                <h2 className="underline fz-60">
                  <a href="mailto:maxvmaasakker@gmail.com">maxvmaasakker@gmail.com</a>
                </h2>
              </div>
            </div>
          </div>
          <div className="row mt-80">
            ...
            <div className="col-lg-3">
              <div className="column">
                ...
                <h5 className="mt-15">
                  <a href="tel:+31622144157"><h5>+31 6 22144157</h5></a>
                </h5>
              </div>
            </div>
          </div>
