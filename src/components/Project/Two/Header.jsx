        ...
        <div className="row">
          <div className="col-lg-6 valign">
            <div className="full-width mb-30">
              <h1 className="fz-60">Kudumu</h1>
              <p>Designed a corporate identity for an African shoe brand committed to fair trade. My responsibilities included creating a name, slogan, logo, and three key identity carriers, all reflecting the brand's ethical values and support for fair compensation for workers.</p>
            </div>
          </div>
