...
//= Static Data
import data from '@/data/AboutMe/services.json';
      ...
      <div className="container">
        <div className="sec-head pb-20 bord-thin-bottom mb-80">
          <div className="d-flex align-items-center">
            <div>
              <h3 className="f-bold text-u">The design process</h3>
            </div>
            <div className="ml-auto">
              <div className="d-flex align-items-center">
                <span className="sub-title ls1 bord">See the process in action</span>
                <a href="/portfolio" className="arrow animsition-link">
